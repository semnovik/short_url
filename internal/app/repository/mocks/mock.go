...
func (m *MockURLRepo) Add(url string) int {
	m.ctrl.T.Helper()
...
func (m *MockURLRepo) Get(urlID int) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockURLRepoMockRecorder) Get(urlID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockURLRepo)(nil).Get), urlID)
}
