...
//go:generate minimock -i short_url/internal/app/repositories.URLRepo -o ./internal/app/repositories/repo_mock/url_repo.go -n URLRepoMock
...
func (mmAdd *URLRepoMock) Add(url string) (uuid string) {
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		return (*mm_results).uuid // nolint:govet
	}
...
func (mmGet *URLRepoMock) Get(uuid string) (url string, err error) {
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		return (*mm_results).url, (*mm_results).err // nolint:govet
	}
